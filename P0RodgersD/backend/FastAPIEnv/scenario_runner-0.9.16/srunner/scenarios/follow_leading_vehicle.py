...
class FollowLeadingVehicle(BasicScenario):
    ...
    def _initialize_actors(self, config):
        ...
        print(f"DEBUG: Requesting Nissan at {transform.location}")
        first_vehicle = CarlaDataProvider.request_new_actor('vehicle.nissan.patrol', transform)
        self.other_actors.append(first_vehicle)

        if first_vehicle is None:
            print("DEBUG: SPAWN FAILED! Check console for CARLA errors.")
        else:
            print(f"DEBUG: SPAWN SUCCESS! ID: {first_vehicle.id}")
