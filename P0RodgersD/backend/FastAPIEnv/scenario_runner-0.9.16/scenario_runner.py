...
# Get the absolute path to the directory containing scenario_runner.py
current_dir = os.path.dirname(os.path.abspath(__file__))

# 1. Add the root directory (so 'srunner' can be found)
if current_dir not in sys.path:
    sys.path.insert(0, current_dir)

# 2. Add the scenarios directory specifically
# This fixes the 'actor_flow' ModuleNotFoundError
scenarios_dir = os.path.join(current_dir, 'srunner', 'scenarios')
